...
@section('title')
    <title>Delivery | CG-Marine</title>
@stop

@section('left-content')
    <div class="col-md-5" style="margin-top: 0 !important; overflow: hidden;">
        {{--<div><img src="/img/delivery.png" alt="about-overview" style="height:550px; max-width: 100%;"/></div>--}}
        <div class="left-img" style="background:url('/img/delivery.png');"></div>
    </div>
    ...
    <div class="col-md-6" style="margin-top: 40px !important; margin-left: 30px !important;">
        <div class="row-fluid">
            <div class="span12" style="color:#777">
                ...
                <h2 style="color: #0072B2">Delivery</h2>
