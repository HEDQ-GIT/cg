<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://ogp.me/ns/fb#" xmlns:addthis="http://www.addthis.com/help/api-spec" xml:lang="en" lang="en" dir="ltr" class="js en wf-brandongrotesque-n7-active wf-museoslab-i3-active wf-museoslab-n1-active wf-museoslab-n3-active wf-museoslab-n7-active wf-active"><!-- <![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" src="./Contact Us _ Combadi_files/widgets.js"></script>
    <meta charset="utf-8">
...
<div id="content">
    ...
    <section id="contact">
        <div class="row wrapper">
            <form id="contact-form" class="styled-form col-lg-8 col-md-8 col-sm-8" action="" method="post">
            ...
            <div id="contact-info" class="col-lg-4 col-md-4 col-sm-4">
                <div>
                    ...
                    <p class="detail"><a href="mailto:info@combadi.com" title="Click to send us an email">info@cg-marine.com</a></p>
                    <p class="title">Telephone</p>
                    <p class="detail"><a href="tel:00306977447033" title="Click to call us">+65 8238 9341</a></>
                    <p class="title">Fax</p>
                    <p class="detail"><a href="skype:combaditravel?call" title="Click to call us on Skype">+65 8238 9341</a></p>
